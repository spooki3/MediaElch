...
QString formatFileSize(const qint64 &size)
{
    if (size > 1024 * 1024 * 1024) {
        return QStringLiteral("%1 GB").arg(QString::number((float)size / 1024 / 1024 / 1024, 'f', 2));
    } else if (size > 1024 * 1024) {
        return QStringLiteral("%1 MB").arg(QString::number((float)size / 1024 / 1024, 'f', 2));
    } else if (size > 1024) {
        return QStringLiteral("%1 kB").arg(QString::number((float)size / 1024, 'f', 2));
    } else {
        return QStringLiteral("%1 B").arg(QString::number((float)size, 'f', 2));
    }
}
